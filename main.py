...
from code.algorithms.random_algorithm import random_algorithm_1, random_algorithm_2, random_algorithm_3, random_algorithm_4
...
if __name__ == "__main__":
    ...
    score, route, description = random_algorithm_4(state)
